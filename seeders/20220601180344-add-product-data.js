    ...
    */
    await queryInterface.bulkInsert('Products', [
      ...
      },
      {
        ...
        category: 'Lunch',
        calories: 1000,
        img: "https://www.acouplecooks.com/wp-content/uploads/2021/09/Tomato-Soup-004.jpg",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
      ...
      },
      {
        ...
        category: 'Lunch',
        calories: 1200,
        img: "https://www.cakenknife.com/wp-content/uploads/2019/10/Crispy-Korean-BBQ-Chicken-Wings_thumbnail-2-1-720x720.jpg",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        name: 'Brice\'s Eggs',
        price: 500,
        description: 'Good ole fashioned eggs',
        category: 'Breakfast',
        calories: 800,
        img: "https://www.jessicagavin.com/wp-content/uploads/2020/09/how-to-fry-an-egg-3-1200.jpg",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
      ...
      },
      {
        ...
        price: 700,
        description: 'Nice golden brown hashbrowns',
        category: 'Breakfast',
        calories: 1100,
        img: "https://food-images.files.bbci.co.uk/food/recipes/hashbrowns_12454_16x9.jpg",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
      ...
      },
      {
        ...
        price: 500,
        description: 'Pastry filled with goodness',
        category: 'Breakfast',
        calories: 1300,
